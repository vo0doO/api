...
<a name="general"></a>
Обратите внимание, что в зависимости от переданного токена могут прийти ответы, содержашие разные тела. В случае токена для приложения ответ будет содержать только некоторые флаги.
